...
`;
	...
	context.after(scratch.cleanup);
	limen(scratch, "init");
	const dirtyId = onlyJobId(limen(scratch, "spawn", "--detached", "--label", "F079 dirty", "edit a file").stdout);
	...
	const cleanId = onlyJobId(limen(scratch, "spawn", "--detached", "--label", "F079 clean", "keep reading").stdout);
