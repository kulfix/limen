...
Keep F091 ACTIVE, with no outcome file or PROVEN mark. The new inspection capability does not waive live receiver proof or Adam's review. Operators should note the documented 64-target selection limit and added automatic `finishEvent` payload field. Private configuration and production receiver contracts were not inspected or changed.
